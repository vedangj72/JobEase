    ...
    <Card className="my-3" style={{boxShadow:"rgb(29 129 29 / 82%) 5px 10px", width:"60%",margin:"auto"}}>
      {
        ...
        <>
        <Card.Body>
        <Card.Title className="text-center mb-4"style={{ fontSize: "30px", fontFamily: 'Roboto, sans-serif',fontWeight: 'bold' }}>{data.name}</Card.Title>
        ...
        <Card.Text><strong>Personal Email:</strong> {data.email}</Card.Text>
      </Card.Body>
      <Link to={`/hireme/${id}`}>
      <center><Button className="center" variant="dark"style={{backgroundColor:"green"}} >Hire</Button>
      </center>
      </Link>
        </>
      }
